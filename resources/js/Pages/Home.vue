                ...
                <div class="col-12 col-md-8 col-lg-9">
                    <div class="wrap-main-slide">
                        <vueper-slides autoplay :dragging-distance="200">
                            <vueper-slide
                                v-for="(product, index) in $page.props
                                    .home_sliders"
                                :key="product.id"
                            >
                                <template #content>
                                    <div class="slide-carousel">
                                        <img
                                            :src="`${
                                                $page.props.asset
                                            }images/home-sliders/blog-article-${
                                                index + 1
                                            }.jpg`"
                                            alt=""
                                            class="w-100"
                        ...
                        <div class="col">
                            ...
                            <div class="wrap-banner style-twin-default">
                                <div class="banner-item">
                                    <a
                                        href="#"
                                        class="link-banner banner-effect-1"
                                    >
                                        <figure>
                                            <img
                                                :src="`${$page.props.asset}images/home-1-banner-1.jpg`"
                                                alt=""
                                                width="580"
                                                height="190"
                                            />
                                ...
                                <div class="banner-item">
                                    ...
                                    >
                                        <figure>
                                            <img
                                                :src="`${$page.props.asset}images/home-1-banner-2.jpg`"
                                                alt=""
                                                width="580"
                                                height="190"
                                            />
                            ...
                            >
                                <div
                                    class="col-12 wrap-show-advance-info-box has-countdown"
                                >
                                    <h3 class="title-box">On Sale</h3>
                                    <div
                                        class="px-4 wrap-countdown mercado-countdown"
                                        :data-expire="
                                            formatDate(
                                                $page.props.on_sale_time
                                                    .sale_date
                                    ...
                                    <div
                                        ...
                                        :data-items="$page.props.on_sale.length"
                                        data-loop="false"
                                        data-nav="true"
                                        data-dots="false"
                                        data-responsive=""
                                ...
                                <div class="col-12 px-4">
                                    ...
                                    >
                                        ...
                                        >
                                            <template #content>
                                                <div
                                                    class="product product-style-2 px-1 mb-2 h-100"
                                                >
                                                    <div
                        ...
                        >
                            ...
                            <div class="wrap-top-banner">
                                <a href="#" class="link-banner banner-effect-2">
                                    <figure>
                                        <img
                                            :src="`${$page.props.asset}images/digital-electronic-banner.jpg`"
                                            width="1170"
                                            height="240"
                                            alt=""
                                        />
